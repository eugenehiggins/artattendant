...
if( !class_exists( 'EDD_FES_Draft' ) ) {
    ...
    class EDD_FES_Draft {
        ...
        function edd_fes_draft_html_fes_field( $fields, $form, $user_id, $readonly ) {
           ...
           //* anagram add "template" title for container *//
            $html_field = new FES_HTML_Field(array( 'html' => $html, 'template'   => 'draft-holder' ), $form, 'custom', $form->save_id);
        ...
        public function edd_fes_draft_after_form_save_frontend( $output, $save_id, $values, $user_id ) {
            ...
            if(isset($values['save_draft'])) {
                ...
                $post->post_status = 'private'; //anagram change draft to private
