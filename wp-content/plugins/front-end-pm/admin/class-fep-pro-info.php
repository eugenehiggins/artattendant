	...
	function settings_fields( $fields )
		{	
			...
			$fields['eb_newmessage_template'] =   array(
				...
				'options'	=> apply_filters( 'fep_eb_template', $templates, 'newmessage' ),
				);
			...
			$fields['eb_reply_template'] =   array(
				...
				'type'	=>	'select',
				//'description' => __( 'Admin alwayes have Wp Editor.', 'front-end-pm' ),
				'options'	=> apply_filters( 'fep_eb_template', $templates, 'reply' ),
				);
			...
			$fields['eb_announcement_template'] =   array(
				...
				'type'	=>	'select',
				//'description' => __( 'Admin alwayes have Wp Editor.', 'front-end-pm' ),
				'options'	=> apply_filters( 'fep_eb_template', $templates, 'announcement' ),
				);
