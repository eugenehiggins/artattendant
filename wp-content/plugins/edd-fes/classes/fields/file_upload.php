							...
							foreach ( $uploaded_items as $index => $attach_id ) {
								...
								<tr class="fes-single-variation">
									...
									?>
									 ...
									 <?php printf( '<a href="%s">%s</a>', wp_get_attachment_url( $attach_id ), __( '<i class="fa fa-file" aria-hidden="true"></i> Download File', 'edd_fes' ) ); ?><?php }//anagram / geet new link/field ?>
