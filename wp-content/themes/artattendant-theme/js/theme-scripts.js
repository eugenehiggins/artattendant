...
//jQuery(function ($) {
    ...
    $('#open-close-tab').click(function () {
        ...
        $dc = $("#dash-content");
        if($dc.hasClass("in")){
            $("#open-close-tab .close").css("display","none");
            $("#open-close-tab .open").css("display","inline-block");
        } else {
            $("#open-close-tab .close").css("display","inline-block");
            $("#open-close-tab .open").css("display","none");
        }
    })
